document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async function (e) {
    ...
    try {
      ...
      doc.text("Melt Cosmetics", 20, y); y += lineHeight;
  ...
  function afterDownloadSuccess(data) {
    try {
      ...
      if (emailLink) {
        ...
        emailLink.href = `mailto:meltcollaboration@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(bodyPlain)}`;
